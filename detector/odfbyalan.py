...
def detecta(audioin,option,backgroud): # ODF main function
	...
	try:
		...
		listadet = deteccoes(audioin,option) # Call deteccoes function
...
if __name__ == '__main__':
	...
	detecta(sys.argv[1],3,10)
	gc.collect()
	detecta(sys.argv[1],4,10)
	gc.collect()
	detecta(sys.argv[1],6,10)
	gc.collect()
